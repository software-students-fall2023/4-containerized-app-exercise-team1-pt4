...
def flask_app_fixture():
    ...
    flask_app.config[
        "MONGO_URI"
    ] = "mongodb://localhost:27017/test_db"  # Adjust as necessary
    return flask_app
...
def test_transcription_success(client_fixture, mock_requests_post_fixture, monkeypatch):
    ...
    mock_requests_post_fixture.return_value.json.return_value = {
...
def test_transcription_api_failure(
    client_fixture, mock_requests_post_fixture, monkeypatch
):
